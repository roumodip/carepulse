...
const Success = async ({ params, searchParams }: SuccessProps) => {
  ...
  const userId = resolvedParams.userId; // Access userId from params
  const appointmentId = resolvedSearchParams.appointmentId || '';
  const someParam = resolvedSearchParams.someParam || '';
      ...
      <div className='success-img'>
        ...
        <section className='flex flex-col items-center'>
          ...
          <h2 className="header mb-6 max-w-[600px] text-center">
            Your <span className="text-purple-500">appointment request</span> has
